...
from model.pdecno.filtered_networks import LReLu, LReLu_regular #Either "filtered LReLU" or regular LReLu
...
#     net = CNO(in_dim=15, in_size=64)
#     x=torch.rand([3,15,64,64])
#     y = net(x)
